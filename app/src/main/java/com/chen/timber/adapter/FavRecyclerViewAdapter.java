 ...
 */
public class FavRecyclerViewAdapter extends RecyclerView.Adapter<FavRecyclerViewAdapter.SongViewHolder>{
	private Context context;
	private List<MusicInfo> musicList;
	public FavRecyclerViewAdapter(Context context, List<MusicInfo> musicList){
		this.context=context;
		this.musicList=musicList;
	}
	@Override
	public SongViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		SongViewHolder holder = new SongViewHolder(LayoutInflater.from(context).inflate(R.layout.item_fav, parent, false));
		return holder;
	}
	...
	public void setOnPopClickListener(FavRecyclerViewAdapter.onPopClickListener onPopClickListener) {
